	...
	public class OffertaDAO {
	 ...
	 // Offerte inviate dall'utente che è il mittente della richiesta (matricola = utente corrente)
	    public List<Offerta> getOfferteInviateByUtente(String matricola) throws SQLException {
	        List<Offerta> list = new ArrayList<>();
	        // Solo le offerte INVIATE da te, che non sono offerte ricevute sui tuoi annunci
